...
{
    [DllImport("discord-rpc-64", EntryPoint = "Discord_Initialize", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("discord-rpc-64", EntryPoint = "Discord_Shutdown", CallingConvention = CallingConvention.Cdecl)]
    public static extern void Shutdown();

    [DllImport("discord-rpc-64", EntryPoint = "Discord_RunCallbacks", CallingConvention = CallingConvention.Cdecl)]
    public static extern void RunCallbacks();

    [DllImport("discord-rpc-64", EntryPoint = "Discord_UpdatePresence", CallingConvention = CallingConvention.Cdecl)]
    private static extern void UpdatePresenceNative(ref DiscordRpc.RichPresenceStruct presence);

    [DllImport("discord-rpc-64", EntryPoint = "Discord_ClearPresence", CallingConvention = CallingConvention.Cdecl)]
    public static extern void ClearPresence();

    [DllImport("discord-rpc-64", EntryPoint = "Discord_Respond", CallingConvention = CallingConvention.Cdecl)]
    public static extern void Respond(string userId, Asparlose.Interop.Discord.Rpc.Win32.DiscordRpcReply reply);

    [DllImport("discord-rpc-64", EntryPoint = "Discord_UpdateHandlers", CallingConvention = CallingConvention.Cdecl)]
